                            ...
                            <div class="card-body ">
                                <form method="post" action="<?=base_url('empaquetado/nuevo_guardar');?>"  autocomplet="off">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                            <label>Nº piezas pernil</label>
                                            <div class="form-group">
                                                <input type="number" name="p_pernil" class="form-control" min="0.0" step="0.01" placeholder="Piezas de pernil" required>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                            <label>Paleta</label>
                                        ...
                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                            <label>Nº piezas paleta</label>
                                            <div class="form-group">
                                                <input type="number" name="p_paleta" class="form-control" min="0.0" step="0.01" placeholder="Piezas de paleta" required>
                                            </div>
                                        </div>
                                    </div><br>
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                            <label>Nº piezas peine</label>
                                            <div class="form-group">
                                                <input type="number" name="p_peine" class="form-control" min="0.0" step="0.01" placeholder="Piezas de peine" required>
                                            </div>
                                        </div>                                    
                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-3 col-sm-12 col-xs-12">
                                            <label>Nº piezas costilla</label>
                                            <div class="form-group">
                                                <input type="number" name="p_costilla" class="form-control" min="0.0" step="0.01" placeholder="Piezas de costilla" required>
                                            </div>
                                        </div>
                                    </div><br>
                                    <div class="row">
